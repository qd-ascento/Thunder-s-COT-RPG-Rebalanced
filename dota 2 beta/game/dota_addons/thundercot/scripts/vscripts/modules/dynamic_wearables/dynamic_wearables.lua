require("modules/dynamic_wearables/data")
LinkLuaModifier("modifier_arena_wearable", "modules/dynamic_wearables/dynamic_wearables.lua", LUA_MODIFIER_MOTION_NONE)
