...
function NeutralSlot:_init()
    CustomGameEventManager:RegisterListener("on_drop_item_to_slot", Dynamic_Wrap(self, 'OnDragEnd'))

    self.kv_data = LoadKeyValues("scripts/npc/overrides/neutral_slot_whitelist.txt")
end
