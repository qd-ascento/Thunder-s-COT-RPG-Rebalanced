...
--------------------------------------------------------------------------------
--------------------------------------------------------------------------------
function modifier_static_amulet:IsHidden()
    return true
end

--------------------------------------------------------------------------------
function modifier_static_amulet:IsPurgable()
    return false
end

--------------------------------------------------------------------------------
function modifier_static_amulet:DestroyOnExpire()
    return false
end

--------------------------------------------------------------------------------
function modifier_static_amulet:IsDebuff()
    return false
end

--------------------------------------------------------------------------------
function modifier_static_amulet:RemoveOnDeath()
    return false
end

--------------------------------------------------------------------------------
function modifier_static_amulet:OnCreated(kv)
...
-----------------------------------------------------------------------------
function modifier_static_amulet:GetAttributes()
    return MODIFIER_ATTRIBUTE_PERMANENT
end

--------------------------------------------------------------------------------
function modifier_static_amulet:DeclareFunctions()
    local funcs = {
...
--------------------------------------------------------------------------------
function modifier_static_amulet:GetModifierPhysicalArmorBonus(kv) return self.bonus_armor; end

function modifier_static_amulet:GetModifierBonusStats_Strength(kv) return self.bonus_stats; end

function modifier_static_amulet:GetModifierBonusStats_Agility(kv) return self.bonus_stats; end

function modifier_static_amulet:GetModifierBonusStats_Intellect(kv) return self.bonus_stats + self.bonus_int; end

--------------------------------------------------------------------------------

function modifier_static_amulet:OnAbilityExecuted(keys)
