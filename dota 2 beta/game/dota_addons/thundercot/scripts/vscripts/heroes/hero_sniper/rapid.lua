...
LinkLuaModifier( "modifier_gun_joe_rapid", 'heroes/hero_sniper/modifiers/modifier_gun_joe_rapid', LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_gun_joe_rapid_cd", 'heroes/hero_sniper/modifiers/modifier_gun_joe_rapid_cd', LUA_MODIFIER_MOTION_NONE )
